...
export const kinds = ['customers','vehicles','appointments','orders','cannedJobs','pricingRules','warranties','inspections','inventory','vendors','purchaseOrders','invoices','payments','timeEntries','campaigns','reviews','users','shops','integrations'] as const
