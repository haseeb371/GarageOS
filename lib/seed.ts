export const demo: Record<string, Array<Record<string,unknown> & {id:string}>> = {
 ...
 supplierQuotes:[{id:'SQ-1',orderId:'RO-4812',partNumber:'BRK-8821',description:'Ceramic brake pad set',quantity:1,supplier:'Metro Parts',brand:'RoadPro',unitCost:62,listPrice:128,coreCharge:0,available:3,deliveryEstimate:'Same day',status:'Quoted',source:'Manual',expiresAt:'',notes:'Example supplier quote.'}],
 partsOrders:[{id:'POR-1',repairOrderId:'RO-4812',quoteId:'SQ-1',supplier:'Metro Parts',providerOrderId:'',partNumber:'BRK-8821',description:'Ceramic brake pad set',quantity:1,total:62,status:'Received',orderedAt:'2026-07-31T08:00:00Z',expectedAt:'2026-07-31',receivedQuantity:1,tracking:'',notes:''}],
 laborGuideEntries:[{id:'LG-1',vehicleId:'V-202',operation:'Front brake pads and rotors',system:'Brakes',standardHours:2.2,warrantyHours:1.8,source:'Shop-authored',sourceReference:'',notes:'Example only; verify before quoting.'}],
 maintenanceSchedules:[{id:'MS-1',vehicleId:'V-201',service:'Engine oil and filter',intervalMileage:5000,intervalMonths:6,source:'Shop-authored',notes:'Adjust for operating conditions.'}],
 vehicleSpecifications:[{id:'VS-1',vehicleId:'V-201',category:'Fluids',name:'Engine oil capacity',value:'Verify by engine',unit:'',source:'Shop-authored',notes:'Licensed provider required for authoritative capacity.'}],
 tires:[{id:'TIR-1',sku:'TIRE-22565',brand:'Roadline',model:'Touring A/S',width:225,aspectRatio:65,wheelDiameter:17,loadIndex:'102',speedRating:'H',season:'All season',dotCode:'2426',onHand:4,cost:102,price:169,location:'Tire rack',active:true}],
 tireServices:[{id:'TS-1',vehicleId:'V-201',date:'2026-07-31',service:'Tire inspection',position:'All',mileage:64120,treadDepth:6,pressure:35,tireId:'TIR-1',dotRegistered:false,notes:'Even wear across all four tires.'}],
 ...
 capacityResources:[{id:'CAP-1',name:'Bay 1',type:'General bay',capacityHours:8,skills:'General service, brakes',active:true},{id:'CAP-2',name:'Alignment rack',type:'Specialty bay',capacityHours:8,skills:'Alignment, tires',active:true}],
 availabilityRules:[{id:'AV-1',name:'Weekday operations',days:'Monday-Friday',opens:'08:00',closes:'17:00',slotMinutes:30,maxConcurrent:4,bufferMinutes:15,active:true}],
 workflowAutomations:[{id:'WF-1',name:'Appointment confirmation',trigger:'Appointment created',conditions:'Source is online booking',action:'Create confirmation task',delayMinutes:0,status:'Active',lastRunAt:'',runCount:0,requiresApproval:false}],
 bookingChannels:[{id:'BC-1',name:'AutoGaragify booking page',type:'Website',status:'Active',publicUrl:'/book/shop-main',calendarId:'',leadTimeHours:2,horizonDays:60,services:'General service',notes:''},{id:'BC-2',name:'Google booking',type:'Google',status:'Not connected',publicUrl:'',calendarId:'',leadTimeHours:2,horizonDays:60,services:'',notes:'Provider approval required.'}],
 integrationConnections:[{id:'CON-1',name:'Accounting connector',provider:'CSV / webhook / QuickBooks / Xero',category:'Accounting',status:'Ready',direction:'Outbound',lastSyncAt:'',schedule:'Manual',regions:'Global',notes:'Use Reports → Sync accounting or Run sync here.'},{id:'CON-2',name:'CRM connector',provider:'Generic webhook',category:'CRM',status:'Ready',direction:'Two-way',lastSyncAt:'',schedule:'Manual',regions:'Global',notes:''}],
 syncRuns:[],
 supportTickets:[],
 compliancePolicies:[{id:'POL-1',name:'Data retention policy',category:'Privacy',version:'1.0',status:'Draft',effectiveDate:'',owner:'Shop owner',reviewDate:'',notes:'Configure for each operating jurisdiction.'}],
 incidents:[],
