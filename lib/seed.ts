export const demo: Record<string, Array<Record<string,unknown> & {id:string}>> = {
 ...
 bookingChannels:[{id:'BC-1',name:'AutoGragify booking page',type:'Website',status:'Active',publicUrl:'/book/shop-main',calendarId:'',leadTimeHours:2,horizonDays:60,services:'General service',notes:''},{id:'BC-2',name:'Google booking',type:'Google',status:'Not connected',publicUrl:'',calendarId:'',leadTimeHours:2,horizonDays:60,services:'',notes:'Provider approval required.'}],
