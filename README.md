...
- Customer-facing booking pages at `/book/[location-id]`
...
- Date/mileage service reminders, reviews and shop responses
- Editable multi-location records, authenticated employee roles, adapter status and audit log
